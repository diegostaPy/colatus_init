...
void initialize_powerspectrum(void)
{
  ...
  AA = 6.4 / ShapeGamma * (3.0856776e24  / UnitLength_in_cm);
  BB = 3.0 / ShapeGamma * (3.0856776e24  / UnitLength_in_cm);
  CC = 1.7 / ShapeGamma * (3.0856776e24  / UnitLength_in_cm);
  nu = 1.13;

  R8 = 8 * (3.0856776e24 / UnitLength_in_cm);	/* 8 Mpc/h */
...
double TopHatSigma2(double R)
{
  ...
  gsl_integration_qag(&F, 0, 500.0 * 1 / R,0, 1.0e-8, WORKSIZE, GSL_INTEG_GAUSS41, workspace, &result, &abserr);
...
double growth(double a)
{
  ...
  gsl_integration_qag(&F, 0, a, 0, 1.0e-12, WORKSIZE, GSL_INTEG_GAUSS41, workspace, &result, &abserr);
