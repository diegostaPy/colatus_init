...
void displacement_fields(void)
{
  ...
  if(ThisTask == 0)
    printf("h %f a %f vel_prefac= %g  hubble_a=%g fom=%g \n",Hubble,InitTime,vel_prefac, hubble_a, F_Omega(InitTime));
  ...
  if(ThisTask == 0)
    {
      ...
      kstart = 2 * PI / (1000.0 * (3.0856776e24 / UnitLength_in_cm));	/* 1000 Mpc/h */
      kend = 2 * PI / (0.001 * (3.0856776e24 / UnitLength_in_cm));	/* 0.001 Mpc/h */
